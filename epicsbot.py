...
async def box(ctx, *args):
        ...
        print("hello there : flag  w 00")
        ELEMENT = ctx.message.content
        print("hello there : flag  e 00 elem:" + ELEMENT)
        SUBELEMENT =  ELEMENT.split(' ')
        print("hello there : flag r 00")
        SUBSUB0 =  SUBELEMENT[1]
        print("hello there : flag w: " + SUBSUB0)
        SUBSUB = SUBSUB0[0 : 1]
      if (SUBSUB == "-"):
                print("helllo flag  2a")
                print("helllo flag  2b" + SUBSUB)
    ...
    embed.add_field(name="Minting", value=description, inline=True)
        ...
        embed.set_footer(text='Copyleft (C) 2021 SCD Hub Bot GPLv3', icon_url=footer_icon)
        print("flag 2")
